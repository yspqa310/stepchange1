...
@CucumberOptions(
        ...
        monochrome = true,
        features = "src/test/resources/FeatureFile/89949_CSR_Joint_Separate_Solutions - DRO.feature",
        glue = {"com.stepChangeRem.remediation.test.StepDefinition.CSR"},

        tags= "@JointSeparateSolutionsDRONorthernIreland_SC89949"
)
public class CSR_89949 {
    @AfterClass
